                ...
                <div class="row">
                  ...
                  <div class="content_board">
                    ...
                    <form action="/OnlineShopingProject/UserController" method="post" class="form_add">
                     ...
                     <input type="hidden"  class="form_add_list form_fname" 
                     	name="userId" value="${user.cId}" />
                        <font color="red"></font>
                        <br/>
                    ...
                    <input type="text" placeholder="phone no" class="form_add_list form_pass" 
                     name="phoneno" value="${user.phone_no}" />
                     <font color="red"></font>
                     <br/>
                    
				<input type="submit" class="btn text-muted text-center btn-success btn_add" value="Update"/>
            </form>
                    </div>
                  </div>
               </div>   
